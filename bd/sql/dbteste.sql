...
col05 varchar(100) default(`àlguma coisa `),
...
insert into teste(col02,col01,col03,col04) value(15.9,11,4,3);
insert into teste(col02,col01,col05,col06) value(0,100,`outra coisa`,`senai`);
insert into teste(col02,col01,col05,col06) value(0.100,`mesma coisa`, `SENAI02`);