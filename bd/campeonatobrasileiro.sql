...
-- corrigir a coluna chave primaria das tabelas 
...
-- apagando a regra da chave estrangeira 
...
alter table evento drop FK_EventoJogador 
alter table jogador modify id_jogador int auto_increment;
alter table add constraintFK_EventoJogador
